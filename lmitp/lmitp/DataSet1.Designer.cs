...
namespace lmitp {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrdersRow AddOrdersRow(System.DateTime OrderDate, decimal TotalAmount, int CustomerId) {
...
namespace lmitp.DataSet1TableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Orders] WHERE (([Id] = @Original_Id) AND ([OrderDate] = @Original_Or" +
                "derDate) AND ([TotalAmount] = @Original_TotalAmount) AND ([CustomerId] = @Origin" +
                "al_CustomerId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Orders] ([OrderDate], [TotalAmount], [CustomerId]) VALUES (@OrderDat" +
                "e, @TotalAmount, @CustomerId);\r\nSELECT Id, OrderDate, TotalAmount, CustomerId FR" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Orders] SET [OrderDate] = @OrderDate, [TotalAmount] = @TotalAmount, [CustomerId] = @CustomerId WHERE (([Id] = @Original_Id) AND ([OrderDate] = @Original_OrderDate) AND ([TotalAmount] = @Original_TotalAmount) AND ([CustomerId] = @Original_CustomerId));
SELECT Id, OrderDate, TotalAmount, CustomerId FROM Orders WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, OrderDate, TotalAmount, CustomerId\r\nFROM            Orders";
